...
def main(argv):
  ...
  try:
    ...
    print 'umacheckdistance.py --input=<inputfile> --station=<stationlist> --output=<output>'
    sys.exit(2)
  for opt, arg in opts:
    if opt == '-h':
      print 'umacheckdistance.py --input=<inputfile> --station=<stationlist> --output=<output>'
  ...
  foutput.write("DIST_MIN,")
  foutput.write("NOMBRE,")
  foutput.write("LONG_UMA,")
  foutput.write("LAT_UMA")
  foutput.write("\n")
  ...
  with fiona.open(inputfile_g) as umasrc:
    for uma in umasrc:
      ...
      #~ print uma
      indexuma  = str(uma['properties']['indexuma']) 
      ...
      print "Punto: " + str(contadorPuntos) + " Index UMA: " + str(indexuma) + " Station: " + station_min + " Distancia Minima: " + str(distancia_minima) + " Distancia Maxima: " + str(distancia_maxima);
      ...
      foutput.write("\""+str(station_min)+"\",")
      foutput.write(str(long_station)+",")
      foutput.write(str(lat_station))
      foutput.write("\n")
